...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    /// </summary>
    public class UI_BindingKey : MonoBehaviour
    {
        /// <summary>
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<UI_BindingKey>();
        ...
        private static List<UI_BindingKey> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<UI_BindingKey, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<UI_BindingKey, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
